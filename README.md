...
입사지원시 제출할 포트폴리오 사이트를 만들고 싶어서 개발하였으며, 개발자 포트폴리오를 검색했을 때 검색결과에 나올 수 있도록 검색엔진최적화를 하고자 개발하였습니다.

- 프로젝트 소개
사용자의 피드백을 받아서 유지보수 하고 있는 사이트입니다. PWA를 적용하여 어플리케이션처럼 브라우저에서 다운로드 받아서 사용하실 수 있습니다.
