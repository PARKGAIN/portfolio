const data = [
    {
        ...
        reference: "스톰프(https://jeonghwan-kim.github.io/2022/10/31/stomp), 슬랙클론강의(https://github.com/ZeroCho/sleact)",
    ...
    },
    {
        ...
        reference: "텍스트에디터라이브러리(https://velog.io/@holim0/React-Quill-사용해보기), Nginx(https://juneyr.dev/nginx-basicshttps://jizard.tistory.com/308), 이미지서버(https://seoyun-is-connecting-the-dots.tistory.com/313)",
    ...
    {   
        ...
        techstack: "Next.js",
        reference: "Carousel(https://dev.to/siaust/make-your-own-html-carousel-in-react-177k), SEO(https://parkgain.tistory.com/54)",
